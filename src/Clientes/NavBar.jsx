...
const NavBar = () => {
  ...
  return (
    <>
      ...
      <link href="https://fonts.googleapis.com/css2?family=Bebas+Neue&family=Merienda:wght@300..900&display=swap" rel="stylesheet" />
      ...
      <Navbar expand="lg" style={navbarStyle}>
        <Container>
          <Navbar.Brand className="d-flex align-items-center">
            <img src={`data:image/png;base64,${logoEmpresa}`} alt="Logo" style={logoStyle} />
            <span style={{ color: 'white', fontSize: '20px', fontFamily: "Merienda", marginLeft: '5px' }}>{nombreEmpresa}</span>
          </Navbar.Brand>
          ...
          <Navbar.Collapse className="justify-content-end">
            <Nav className="ml-auto">
              <Nav.Link onClick={() => MostrarComponente('Menu')}
                ...
                onMouseOut={manejarMouseOut}>MENU</Nav.Link>
              {Logeado && <NavDropdown
                style={estiloNavLink}
                onMouseOver={manejarMouseOver}
